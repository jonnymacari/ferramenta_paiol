...
class CustomUserCreationForm(UserCreationForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Traduzir labels e help_texts para português
        self.fields['username'].label = 'Nome de usuário'
        self.fields['username'].help_text = 'Campo obrigatório. Máximo 150 caracteres. Apenas letras, números e @/./+/-/_ são permitidos.'
...
class CompleteProfileForm(forms.ModelForm):
    ...
    class Meta:
        ...
        widgets = {
            ...
            'endereco_simples': forms.Textarea(attrs={
                'class': 'form-control', 
                'rows': 3,
...
class UserManagementForm(forms.ModelForm):
    ...
    class Meta:
        ...
        help_texts = {
            'username': 'Campo obrigatório. Máximo 150 caracteres.',
            'email': 'Campo obrigatório. Digite um e-mail válido.',
            'first_name': 'Campo obrigatório.',
            'last_name': 'Campo obrigatório.',
            'user_type': 'Selecione o tipo de usuário.',
            'cpf': 'Campo obrigatório. Digite apenas números.',
            'telefone': 'Campo obrigatório.',
            'endereco_simples': 'Campo obrigatório.',
            'data_nascimento': 'Campo obrigatório.',
        }
    ...
    def clean_email(self):
        ...
        # Se estamos editando, permitir o mesmo email do usuário atual
